let total_2=localStorage.getItem('aidan');
  ...
  for(let record of records){
      ...
      html += `<tr id="${record.title}">
       ...
       <img src="${record.image}">
        ...
        <td><a href="#${record.title}" onclick= "getData23('https://api.spoonacular.com/recipes/${record.id}/information?includeNutrition=false&apiKey=901bb73c94e444f1a6548125427a841d', drawDetails2)" >View more information and Recipie URL </a></td>   
      </tr>`;
  }
  result.innerHTML = html;
}
